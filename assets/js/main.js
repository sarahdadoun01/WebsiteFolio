...
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(event) {
        ...
        fetch(form.action, {
            ...
            if (response.ok) {
                messageContainer.innerHTML = `<p class="success">Thank you! Your message will be read as soon as possible.</p>`;
                form.reset(); // Clears the form after submission
            } else {
                messageContainer.innerHTML = `<p class="error">There was a problem trying to send your message. The error will be reported back to me. For now, email to sarahcdadoun@gmail.com or try this again later.</p>`;
                sendErrorReport(response.statusText);
            }
        }).catch(error => {
            messageContainer.innerHTML = `<p class="error">❌ Error: ${error}</p>`;
            sendErrorReport(error);
        });
    });
});
